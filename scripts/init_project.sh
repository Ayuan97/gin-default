...
echo ""
echo "接下来的步骤:"
echo "1. 编辑 .env 文件配置数据库和Redis连接信息"
echo "2. 创建数据库: $NEW_PROJECT_NAME"
echo "3. 启动项目: go run cmd/${OLD_PROJECT_NAME}-go.go"
echo "4. 访问测试接口: http://localhost:8787/api/v2/test"
echo ""
